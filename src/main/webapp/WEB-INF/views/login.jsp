...
<div class="login">
    <form role="form" action="${path}/login" method="post">
        ...
        <button class="layui-btn  layui-btn-normal jia-login" lay-submit lay-filter="formDemo" style="text-align: left">
            立即登录
        </button>
        <button type="reset" class="layui-btn  layui-btn-danger jia-login-reset">重置</button>
        <p style="margin-bottom: 20px" class="txt"><a class="" href="${path}/register">免费注册</a><a href="forget.html">忘记密码？</a>
        </p>
</div>
</form>
</div>
