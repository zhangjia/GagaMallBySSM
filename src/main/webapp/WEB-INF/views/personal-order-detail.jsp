            ...
            <div class="orderList">
                <div class="orderList1">
                    ...
                    <c:forEach items="${order.order_detail}" var="commodity">
                        <div class="clearfix">
                            <a href="#" class="fl"><img class="spxqtsmall"
                                                        src="${commodity.order_detail_commodity_img}"/></a>
                ...
                <div class="orderList1">
                    ...
                    <p>
                        收货地址：<span>${order.order_address.province} ${order.order_address.city}  ${order.order_address.district} ${order.order_address.contry}${order.order_address.address_detail}</span>
                    </p>
                </div>
                <div class="orderList1">
                    <h3>支付方式/备注</h3>
