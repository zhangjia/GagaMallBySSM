        ...
        <div class="div-sptj" style="padding: 15px;">
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-upload">
                    ...
                    <button type="button" class="layui-btn layui-btn-warm" id="jia-spt-upload">上传商品图</button>
                </div>
                ...
                <div class="layui-upload">
                    ...
                    <button type="button" class="layui-btn layui-btn-warm" id="jia-spxqt-upload">上传商品详情图</button>
                </div>
